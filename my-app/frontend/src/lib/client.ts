...
export function Environment(name: string): BaseURL {
  return `https://${name}-my-app-wmg2.encr.app`;
}
...
/**
 * Client is an API client for the my-app-wmg2 Encore application.
 */
...
class BaseClient {
  ...
  constructor(baseURL: string, options: ClientOptions) {
    ...
    this.headers = {
      ...
      "User-Agent": "my-app-wmg2-Generated-TS-Client (Encore/v1.31.0)",
    };
