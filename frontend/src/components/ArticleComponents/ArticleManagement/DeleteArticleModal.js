...
const DeleteArticleModal = ({ errmsg, setErrMsg, isOpen, onClose, onConfirm }) => {
    ...
    isOpen && (
      <div className={styles.modalOverlay}>
        <div className={styles.modal}>
          <h2 className={styles.modalTitle}>Delete Article</h2>
          <p className={styles.modalText}>Are you sure you want to delete this article? This action cannot be undone.</p>
